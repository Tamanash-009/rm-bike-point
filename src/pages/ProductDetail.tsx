      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
          ...
          <motion.div 
            ...
            className="relative aspect-square rounded-[3rem] overflow-hidden glass border border-text-primary/10"
          >
            <img 
            ...
            <button 
              ...
              className={cn(
                ...
                isInWishlist 
                  ...
                  : "bg-black/20 border-text-primary/10 text-white hover:bg-white/10"
              )}
            >
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.bikeModels.map(model => (
                    <span key={model} className="px-3 py-1 bg-white/5 border border-text-primary/10 rounded-lg text-xs text-gray-300">
                      {model}
                    </span>
                  ))}
                </div>
