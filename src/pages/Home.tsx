...
import { collection, query, limit, getDocs } from '../lib/firebase';
...
export default function Home() {
  ...
  const services = [
    { name: "Brake Overhaul", price: "From ₹499", img: "/service-brake-overhaul.jpg" },
    { name: "General Service", price: "From ₹999", img: "/service-general-service.jpg" },
    { name: "Engine Tuning", price: "From ₹1,499", img: "/service-engine-tuning.jpg" },
  ];
        ...
        <div className="relative z-10 container-custom">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                to="/shop"
                className="bg-white/5 border border-text-primary/10 text-white px-10 py-5 rounded-full font-black uppercase tracking-widest text-xs flex items-center justify-center hover:bg-white/10 transition-all hover:border-text-primary/20 text-sm"
              >
                Explore Parts
              </Link>
            </div>
          ...
          {loading ? (
            ...
            featuredProducts.map((product, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
                className="glass rounded-3xl overflow-hidden group border border-text-primary/10 hover:border-brand-orange/50 transition-colors flex flex-col"
              >
                <div className="aspect-square overflow-hidden relative">
                  <img 
                    ...
                    loading="lazy"
                  />
                  <div className="absolute top-4 left-4 bg-black/80 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest border border-text-primary/10">
                    {product.category}
                  </div>
                </div>
