  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-24">
      ...
      <section>
        ...
        <div className="overflow-hidden rounded-3xl border border-text-primary/10 glass">
        ...
        {selectedService && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto glass rounded-[2.5rem] border border-text-primary/10 shadow-2xl p-8 md:p-12 no-scrollbar"
            >
              <button
                onClick={() => setSelectedService(null)}
      ...
      {/* CTA */}
      <section className="text-center bg-white/5 rounded-[3rem] p-12 border border-text-primary/10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <Link
            to="/contact"
            className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-full font-bold transition-all border border-text-primary/10"
          >
            Contact Mechanics
          </Link>
        </div>
