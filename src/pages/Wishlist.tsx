      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {items.map((item, index) => (
          <motion.div
            ...
            className="glass rounded-3xl overflow-hidden group border border-text-primary/10 hover:border-brand-orange/30 transition-all flex flex-col"
          >
            <div className="aspect-video overflow-hidden relative">
              ...
              <button
                ...
                className="absolute top-4 right-4 p-2 rounded-full bg-black/60 backdrop-blur-md border border-text-primary/10 hover:bg-red-500/20 hover:text-red-500 transition-colors z-10"
