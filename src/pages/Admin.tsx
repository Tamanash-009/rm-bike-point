...
import { collection, getDocs, query, orderBy, doc, getDoc, updateDoc, addDoc, serverTimestamp } from '../lib/firebase';
...
export default function Admin() {
  ...
  useEffect(() => {
    const checkAdmin = async () => {
      ...
      if (user.primaryEmailAddress?.emailAddress === "chakrabortytamanash@gmail.com" || userData?.role === 'admin') {
        setIsAdmin(true);
  ...
  return (
    <AdminLayout activeTab={activeTab} setActiveTab={setActiveTab}>
      ...
      {activeTab === 'dashboard' ? (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
            {loadingData ? (
              ...
              <>
                <div className="bg-card-bg p-8 rounded-[2rem] border border-text-primary/5 group hover:border-brand-orange/30 transition-all">
                ...
                <div className="bg-card-bg p-8 rounded-[2rem] border border-text-primary/5 group hover:border-green-500/30 transition-all">
                  <div className="flex items-center justify-between mb-6">
                ...
                <div className="bg-card-bg p-8 rounded-[2rem] border border-text-primary/5 group hover:border-blue-500/30 transition-all">
                  <div className="flex items-center justify-between mb-6">
                ...
                <div className="bg-card-bg p-8 rounded-[2rem] border border-text-primary/5 group hover:border-purple-500/30 transition-all">
                  <div className="flex items-center justify-between mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-8">
              <section className="bg-card-bg p-4 lg:p-10 rounded-[2.5rem] border border-text-primary/5">
                ...
                <div className="space-y-3">
                  {loadingData ? (
                    [...Array(3)].map((_, i) => (
                      <div key={i} className="bg-white/2 p-4 rounded-3xl border border-text-primary/5 flex items-center justify-between">
                    ...
                    <>
                      ...
                      {bookings.slice(0, 3).map(b => (
                        <div key={b.id} className="bg-white/2 p-5 rounded-3xl border border-text-primary/5 flex items-center justify-between group hover:border-brand-orange/20 transition-all">
                      ...
                      {/* Recent Orders */}
                      {recentOrders.map(o => (
                        <div key={o.id} className="bg-white/2 p-5 rounded-3xl border border-text-primary/5 flex items-center justify-between group hover:border-green-500/20 transition-all">
                          <div className="flex items-center space-x-5">
            ...
            <div className="space-y-6">
              <section className="bg-card-bg p-10 rounded-[2.5rem] border border-text-primary/5">
                <h3 className="text-xl font-black uppercase tracking-tighter mb-8 flex items-center gap-3">
                  <Shield className="w-5 h-5 text-brand-orange" />
                  <span>Management</span>
                </h3>
                <div className="grid grid-cols-1 gap-3">
                  <button onClick={() => setActiveTab('listings')} className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-text-primary/5 hover:bg-brand-orange/10 hover:border-brand-orange/20 transition-all group overflow-hidden relative">
                  ...
                  <button onClick={() => setActiveTab('chat')} className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-text-primary/5 hover:bg-brand-orange/10 hover:border-brand-orange/20 transition-all group overflow-hidden relative">
                    <div className="flex items-center gap-4 relative z-10">
                  ...
                  <button 
                    ...
                    className="flex items-center justify-between p-5 bg-white/5 rounded-2xl border border-text-primary/5 hover:bg-brand-orange/10 hover:border-brand-orange/20 transition-all group overflow-hidden relative"
                  >
                    <div className="flex items-center gap-4 relative z-10">
        ...
        <section className="bg-card-bg rounded-[2.5rem] border border-text-primary/5 overflow-hidden">
          <div className="overflow-x-auto no-scrollbar">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/2 border-b border-text-primary/5 text-[10px] font-black uppercase tracking-[0.3em] text-white/30">
        ...
        <div className="p-24 glass rounded-[3rem] border border-text-primary/5 text-center bg-card-bg">
