...
import { doc, getDoc, collection, query, where, limit, getDocs } from '../lib/firebase';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
          ...
          <section className="space-y-6">
            <motion.div 
              ...
              className="relative aspect-[4/3] rounded-[3rem] overflow-hidden glass border border-text-primary/10"
            >
              <img 
                src={activeImage} 
                ...
                {bike.images.map((img, idx) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeImage === img ? "border-brand-orange scale-105" : "border-text-primary/5 opacity-50 hover:opacity-100"
                    )}
                  >
          ...
          >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isInWishlist 
                      ...
                      : "bg-white/5 border-text-primary/10 text-gray-400 hover:border-brand-orange/50"
                  )}
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
              <div className="glass p-4 rounded-2xl border border-text-primary/5 flex flex-col items-center text-center">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8 text-sm">
              <div className="flex justify-between items-center border-b border-text-primary/5 pb-2">
            ...
            {bike.maintenanceHistory && (
              <div className="mb-12 glass p-8 rounded-[2.5rem] border border-text-primary/10 bg-brand-orange/5">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <a 
                ...
                className="flex-1 glass-button border-text-primary/10 text-white py-4 rounded-2xl font-bold flex items-center justify-center gap-3"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {recommendations.map((item) => (
                <Link 
                  key={item.id} 
                  to={`/bikes/${item.id}`}
                  className="group glass rounded-3xl border border-text-primary/10 overflow-hidden hover:border-brand-orange/30 transition-all duration-500"
                >
