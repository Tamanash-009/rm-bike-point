...
export default function Booking() {
  ...
  useEffect(() => {
    ...
    const unsub = getUserPoints(user.id, setUserPoints);
    return () => unsub();
  }, [navigate, location]);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="glass rounded-[2rem] p-8 md:p-12 border border-text-primary/10">
            ...
            >
              <div className="space-y-4">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-text-primary/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-brand-orange transition-colors"
                />
              </div>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        formData.serviceInterval === interval.value
                          ...
                          : "bg-white/5 border-text-primary/10 text-gray-500 hover:border-white/30"
                      )}
                    >
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="flex gap-4 pt-4">
                <button
                  onClick={handleBack}
                  className="flex-1 bg-white/5 hover:bg-white/10 text-white/60 py-5 rounded-2xl font-black uppercase text-[10px] tracking-widest flex items-center justify-center space-x-2 transition-all border border-text-primary/5 active:scale-95"
                >
          ...
          {step === 3 && (
            ...
            >
              <div className="space-y-6">
                ...
                <div className="space-y-4 bg-white/5 p-6 rounded-2xl border border-text-primary/10">
                  ...
                  {discountAmount > 0 && (
                    <div className="flex justify-between text-green-500 pt-2 border-t border-text-primary/5">
              ...
              <div className="flex gap-4">
                <button
                  onClick={handleBack}
                  className="flex-1 bg-white/5 hover:bg-white/10 text-white py-4 rounded-2xl font-bold flex items-center justify-center space-x-2 transition-all border border-text-primary/10"
                >
