...
import { doc, getDoc, collection, query, orderBy, onSnapshot, addDoc, serverTimestamp, deleteDoc } from '../lib/firebase';
    ...
    <div className="min-h-screen pt-24 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.article
          ...
          className="glass rounded-[2rem] border border-text-primary/10 overflow-hidden mb-12"
        >
          <div className="relative h-[400px]">
            ...
            <div className="absolute bottom-8 left-8 right-8">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-gray-300 font-medium">
                <div className="flex items-center gap-2 bg-black/40 backdrop-blur-md px-4 py-2 rounded-xl border border-text-primary/10">
        ...
        {/* Comments Section */}
        <section className="glass rounded-[2rem] border border-text-primary/10 p-8 md:p-12">
          ...
          <form onSubmit={handleAddComment} className="mb-12">
            {user ? (
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <img 
                    ...
                    alt="User"
                    className="w-10 h-10 rounded-full border border-text-primary/10"
                    referrerPolicy="no-referrer"
                  />
                  <div className="flex-1">
                    <textarea
                      ...
                      className="w-full bg-white/5 border border-text-primary/10 rounded-2xl p-4 min-h-[120px] focus:outline-none focus:border-brand-orange/50 transition-colors"
                    />
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-text-primary/10 rounded-2xl p-8 text-center">
            ...
            {comments.map((comment) => (
              <div key={comment.id} className="flex gap-4 group">
                <img 
                  ...
                  className="w-10 h-10 rounded-full border border-text-primary/10 flex-shrink-0"
                  referrerPolicy="no-referrer"
                />
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {(user?.id === comment.userId || user?.primaryEmailAddress?.emailAddress === 'chakrabortytamanash@gmail.com') && (
                      <button 
