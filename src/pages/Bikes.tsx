        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {filteredBikes.map((bike) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass rounded-[3rem] overflow-hidden group border border-text-primary/10 hover:border-brand-orange/30 transition-all"
            >
              ...
              <div className="p-10 space-y-8">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-white/5 p-4 rounded-2xl border border-text-primary/5 text-center">
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  <Link 
                    to={`/bikes/${bike.id}`}
                    className="flex-1 bg-white/10 hover:bg-white/20 text-white py-4 rounded-2xl font-bold flex items-center justify-center space-x-2 transition-all border border-text-primary/10"
                  >
                    <span>Details</span>
