          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {BASE_BIKES.map((bike) => (
              <div
                ...
                className="glass rounded-[2.5rem] overflow-hidden cursor-pointer group border border-text-primary/10 hover:border-brand-orange transition-all"
              >
      ...
      {step === 2 && selectedBike && (
        ...
        >
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isSelected ? "border-brand-orange bg-brand-orange/5" : "border-text-primary/5 hover:border-text-primary/20"
                    )}
                  >
                    {activeTab === 'paint' ? (
                      <div 
                        className="w-full aspect-video rounded-2xl mb-4 border border-text-primary/10"
          ...
          <div className="lg:col-span-1">
            <div className="glass rounded-[2.5rem] p-8 border border-text-primary/10 sticky top-24">
              <h3 className="text-xl font-bold mb-6">Build Summary</h3>
              
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-start pb-4 border-b border-text-primary/5">
                  <div>
                ...
                {(Object.entries(selections) as [Category, any][]).map(([cat, opt]) => (
                  <div key={cat} className="flex justify-between items-start pb-4 border-b border-text-primary/5">
                    <div>
