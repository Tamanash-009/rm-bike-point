      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        <div className="space-y-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="glass p-8 rounded-3xl border border-text-primary/10">
          ...
          {/* Map Placeholder */}
          <div className="rounded-[3rem] overflow-hidden h-80 border border-text-primary/10 relative">
            <img
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-black/80 backdrop-blur-md px-6 py-3 rounded-full border border-text-primary/20 flex items-center space-x-3">
        ...
        {/* Contact Form */}
        <div className="glass p-12 rounded-[3rem] border border-text-primary/10">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full bg-white/5 border rounded-2xl py-4 px-6 focus:outline-none transition-colors ${
                    errors.email ? 'border-red-500/50' : 'border-text-primary/10 focus:border-brand-orange'
                  }`}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className={`w-full bg-white/5 border rounded-2xl py-4 px-6 focus:outline-none transition-colors ${
                    errors.phone ? 'border-red-500/50' : 'border-text-primary/10 focus:border-brand-orange'
                  }`}
