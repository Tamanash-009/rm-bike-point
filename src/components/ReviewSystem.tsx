...
import { collection, addDoc, query, where, orderBy, onSnapshot, serverTimestamp, deleteDoc, doc } from '../lib/firebase';
...
export default function ReviewSystem({ targetId, targetType }: ReviewSystemProps) {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Review Form */}
      {user ? (
        <form onSubmit={handleSubmit} className="glass p-8 rounded-3xl border border-text-primary/10 space-y-6">
        ...
        <div className="glass p-8 rounded-3xl border border-text-primary/10 text-center">
          ...
          <div className="grid grid-cols-1 gap-6">
            {reviews.map((review) => (
              <motion.div
                ...
                className="glass p-6 rounded-2xl border border-text-primary/10 space-y-4"
              >
                <div className="flex justify-between items-start">
                  <div className="flex items-center space-x-4">
                    {review.userPhoto ? (
                      <img src={review.userPhoto} alt={review.userName} className="w-10 h-10 rounded-full border border-text-primary/10" />
                    ) : (
