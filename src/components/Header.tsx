...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-[110] bg-black/30 backdrop-blur-xl border-b border-text-primary/10 h-20 transition-all duration-300 shadow-lg">
        {/* Desktop View */}
        <DesktopNavbar onLogin={handleLogin} />
