    ...
    <div className={cn("flex items-center gap-3", className)}>
      ...
      {shareLinks.map((link) => (
        <a
          ...
          className={cn(
            "p-2 rounded-xl bg-white/5 text-gray-400 transition-all duration-300 border border-text-primary/10",
            link.color
          )}
      ...
      <button
        ...
        className="p-2 rounded-xl bg-white/5 text-gray-400 transition-all duration-300 border border-text-primary/10 hover:bg-brand-orange/20 hover:text-brand-orange"
        title="Copy Link"
      >
