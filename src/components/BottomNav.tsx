...
export default function BottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-sm z-[80]">
      <div className="glass backdrop-blur-xl border border-text-primary/10 rounded-[2rem] p-4 flex items-center justify-between shadow-2xl relative overflow-hidden">
        {/* Glow effect */}
