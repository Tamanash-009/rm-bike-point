...
export default function Footer() {
  return (
    <footer className="bg-black border-t border-text-primary/10 pt-16 pb-32 lg:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              <li className="flex justify-between items-center bg-white/5 p-3 rounded-xl border border-text-primary/5">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {[
            { src: '/footer-workshop.jpg',  title: 'Workshop' },
            { src: '/footer-service.jpg',   title: 'Service' },
            { src: '/footer-customs.jpg',   title: 'Customs' },
            { src: '/footer-gear.jpg',      title: 'Gear' },
            { src: '/footer-detailing.jpg', title: 'Detailing' },
          ].map((img, i) => (
            <motion.div
              key={i}
              whileHover={{ y: -5 }}
              className="relative aspect-square rounded-2xl overflow-hidden border border-text-primary/5 group"
            >
              <img
                src={img.src}
                alt={img.title}
        ...
        <div className="mt-16 pt-8 border-t border-text-primary/5 flex flex-col md:flex-row justify-between items-center gap-8">
