...
export default function ProfileCard({ user, isAdmin, onLogout, onAdminRedirect }: ProfileCardProps) {
  return (
    <div className="bg-card-bg rounded-[2rem] p-6 border border-text-primary/5 shadow-2xl relative overflow-hidden group">
      {/* Background Accent */}
      ...
      <div className="flex items-center space-x-4 mb-8 relative z-10">
        <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-[#FF5C00]/30 p-1 bg-bg-primary shadow-[0_0_15px_rgba(255,92,0,0.1)]">
          <img 
      ...
      <div className="space-y-3 relative z-10">
        ...
        <button 
          onClick={onLogout}
          className="w-full flex items-center justify-center space-x-3 bg-white/5 hover:bg-white/10 text-white/50 hover:text-white py-4 rounded-xl font-black uppercase tracking-widest text-xs transition-all border border-text-primary/10 active:scale-[0.98]"
        >
