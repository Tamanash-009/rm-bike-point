    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        ...
        >
          ...
          <div className="w-10 h-10 rounded-full border border-text-primary/20 flex items-center justify-center group-hover:bg-white/10 transition-colors">
        ...
        <button 
          ...
          className="flex items-center justify-between p-5 bg-card-bg border border-text-primary/5 rounded-[1.5rem] text-white group active:scale-[0.98] transition-all"
        >
          <div className="flex items-center space-x-4">
          ...
          <div className="w-10 h-10 rounded-full border border-text-primary/5 flex items-center justify-center group-hover:border-[#FF5C00]/30 transition-colors">
