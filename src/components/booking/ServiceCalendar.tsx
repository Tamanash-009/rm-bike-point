    ...
    <div className="flex items-center justify-between mb-8">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="p-3 rounded-xl bg-white/5 border border-text-primary/10 text-white/40 hover:text-white hover:bg-white/10 disabled:opacity-20 transition-all active:scale-95"
        >
          <ChevronLeft className="w-5 h-5" />
        </button>
        <button
          onClick={nextMonth}
          className="p-3 rounded-xl bg-white/5 border border-text-primary/10 text-white/40 hover:text-white hover:bg-white/10 transition-all active:scale-95"
        >
          ...
          <button
            ...
            className={cn(
              ...
              isSelected 
                ...
                : "bg-white/5 border-text-primary/5 text-white/60",
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-8 flex items-center justify-center gap-6">
         ...
         <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded bg-white/5 border border-text-primary/5" />
