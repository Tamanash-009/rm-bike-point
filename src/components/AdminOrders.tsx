...
import { collection, onSnapshot, query, orderBy, doc, updateDoc, addDoc, serverTimestamp } from '../lib/firebase';
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex bg-card-bg p-2 rounded-2xl border border-text-primary/5 gap-4">
      ...
      {orders.length === 0 ? (
        <div className="bg-card-bg p-32 text-center rounded-[3rem] border border-text-primary/5 border-dashed">
        ...
        <div className="space-y-6">
          {orders.map((order) => (
            <motion.div 
              layout
              key={order.id} 
              className="bg-card-bg rounded-[2.5rem] border border-text-primary/5 overflow-hidden hover:border-brand-orange/20 transition-all duration-300"
            >
              <div className="p-8 lg:p-10 border-b border-text-primary/5 flex flex-wrap justify-between items-center gap-8">
                  ...
                  <div className="xl:col-span-7 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {order.items.map((item, idx) => (
                        <div key={idx} className="flex items-center gap-4 bg-white/2 p-4 rounded-2xl border border-text-primary/5 hover:border-text-primary/10 transition-colors">
                          <img 
                  ...
                  <div className="xl:col-span-5 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <button 
                        ...
                        className="bg-white/5 hover:bg-blue-500 text-white/50 hover:text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all border border-text-primary/5 hover:border-blue-500/30 disabled:opacity-20"
                      >
                        Process
                      </button>
                      <button 
                        ...
                        className="bg-white/5 hover:bg-purple-500 text-white/50 hover:text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all border border-text-primary/5 hover:border-purple-500/30 disabled:opacity-20"
                      >
                        Dispatch
                      </button>
                      <button 
                        ...
                        className="bg-white/5 hover:bg-green-500 text-white/50 hover:text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all border border-text-primary/5 hover:border-green-500/30 disabled:opacity-20"
                      >
                        Finalize
                      </button>
                      <button 
                        ...
                        className="bg-white/5 hover:bg-red-500 text-white/50 hover:text-white py-4 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all border border-text-primary/5 hover:border-red-500/30 disabled:opacity-20"
                      >
                        Terminate
                      </button>
                    </div>
