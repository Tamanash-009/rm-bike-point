      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-4 w-64 bg-card-bg border border-text-primary/10 rounded-[1.5rem] shadow-2xl overflow-hidden z-[100]"
          >
            <div className="p-5 border-b border-text-primary/5 bg-brand-orange/5">
            ...
            <div className="p-2 border-t border-text-primary/5">
              <button
