...
import { collection, getDocs, query, orderBy, doc, updateDoc, deleteDoc, onSnapshot } from '../lib/firebase';
    ...
    return (
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
        <div className="lg:col-span-1 space-y-4">
          ...
          {[...Array(5)].map((_, i) => (
            <div key={i} className="glass p-4 rounded-2xl border border-text-primary/5 space-y-2">
        ...
        <div className="lg:col-span-2">
          <div className="glass p-8 rounded-[2.5rem] border border-text-primary/5 space-y-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      <div className="lg:col-span-4 space-y-4">
        ...
        <div className="space-y-2 max-h-[700px] overflow-y-auto pr-2 no-scrollbar">
            ...
            <motion.div 
              ...
              className={cn(
                ...
                selectedQuery?.id === q.id 
                  ...
                  : "bg-card-bg border-text-primary/5 hover:border-text-primary/20",
          ...
          {queries.length === 0 && (
            <div className="text-center py-24 bg-card-bg rounded-[2rem] border border-text-primary/5 border-dashed">
      ...
      <div className="lg:col-span-8">
        {selectedQuery ? (
          <motion.div 
            ...
            className="bg-card-bg p-4 lg:p-12 rounded-[3rem] border border-text-primary/5 shadow-2xl relative overflow-hidden"
          >
            {/* Background elements */}
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-12">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="bg-white/5 px-4 py-2 rounded-xl border border-text-primary/5 flex items-center gap-2">
              ...
              <div className="bg-white/2 p-8 lg:p-10 rounded-[2rem] border border-text-primary/5 text-gray-400 text-base leading-loose mb-12 whitespace-pre-line">
              ...
              <div className="space-y-6">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/2 border border-text-primary/5 rounded-[1.5rem] p-6 text-white text-sm focus:outline-none focus:border-brand-orange/30 transition-all min-h-[160px] resize-none"
                />
          ...
          <div className="h-full min-h-[500px] flex flex-col items-center justify-center bg-card-bg rounded-[3rem] border border-text-primary/5 border-dashed text-gray-600 transition-all">
