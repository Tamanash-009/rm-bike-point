      ...
      <div className="grid grid-cols-1 gap-4">
        {posts.map((post) => (
          <motion.div 
            layout
            key={post.id} 
            className="bg-card-bg p-6 rounded-[2rem] border border-text-primary/5 flex flex-col md:flex-row items-center justify-between group hover:border-brand-orange/20 transition-all duration-300 gap-8"
          >
            <div className="flex items-center gap-8 flex-1 w-full">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <span className="text-[8px] font-black uppercase tracking-widest px-3 py-1 bg-white/5 rounded-full border border-text-primary/5 text-gray-400 group-hover:text-brand-orange group-hover:border-brand-orange/20 transition-all">{post.category}</span>
                  <span className={cn(
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <button 
                ...
                className="flex-1 md:flex-none h-12 px-6 bg-white/5 hover:bg-white/10 rounded-xl text-[10px] font-black uppercase tracking-widest text-white/50 hover:text-white transition-all border border-text-primary/5 flex items-center justify-center gap-3"
              >
              ...
              <button 
                ...
                className="w-12 h-12 bg-white/5 hover:bg-red-500/20 rounded-xl text-red-500 flex items-center justify-center transition-all border border-text-primary/5 hover:border-red-500/30"
              >
        ...
        {posts.length === 0 && (
          <div className="text-center py-32 bg-card-bg rounded-[3rem] border border-text-primary/5 border-dashed">
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-5xl bg-bg-primary rounded-[3rem] border border-text-primary/10 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col"
            >
              <div className="absolute top-0 right-0 w-96 h-96 bg-brand-orange/5 blur-[100px] pointer-events-none" />

              <div className="p-8 border-b border-text-primary/5 flex justify-between items-center relative z-10">
                <div>
              ...
              <form onSubmit={handleSubmit} className="p-10 overflow-y-auto space-y-10 relative z-10 no-scrollbar">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/5 border border-text-primary/5 rounded-2xl px-6 py-4 text-white font-bold focus:outline-none focus:border-brand-orange/30 transition-all"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full bg-white/5 border border-text-primary/5 rounded-2xl px-6 py-4 text-white font-bold focus:outline-none focus:border-brand-orange/30 transition-all appearance-none"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="aspect-video rounded-3xl overflow-hidden bg-white/5 border border-text-primary/5 flex items-center justify-center group relative">
                      {formData.imageUrl ? (
                        <>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full bg-white/5 border border-text-primary/5 rounded-2xl px-6 py-4 text-white text-xs focus:outline-none focus:border-brand-orange/30 transition-all font-mono"
                        />
                      </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/5 border border-text-primary/5 rounded-2xl px-6 py-4 text-white text-sm focus:outline-none focus:border-brand-orange/30 transition-all min-h-[100px] leading-relaxed"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white/5 border border-text-primary/5 rounded-[2rem] px-8 py-10 text-white text-base focus:outline-none focus:border-brand-orange/30 transition-all min-h-[400px] font-mono leading-loose no-scrollbar"
                  />
                </div>

                <div className="flex flex-col sm:flex-row justify-between items-center gap-8 pt-6 border-t border-text-primary/5">
                  <div className="flex items-center gap-6 bg-white/5 p-2 rounded-2xl border border-text-primary/5">
                    <button 
                      type="button"
                  ...
                  <div className="flex gap-4 w-full sm:w-auto">
                    ...
                    >
                      {submitting ? (
                        <>
                          <div className="w-4 h-4 border-2 border-text-primary/20 border-t-white rounded-full animate-spin" />
