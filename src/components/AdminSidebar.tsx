...
export default function AdminSidebar({ isOpen, onClose, activeTab, setActiveTab }: SidebarProps) {
  ...
  const NavButton = ({ item }: { item: NavItem }) => {
    ...
    return (
      ...
      >
        ...
        {isCollapsed && (
          <div className="absolute left-full ml-4 px-3 py-2 bg-card-bg text-white text-xs font-bold rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity border border-text-primary/5 whitespace-nowrap z-50">
            {item.name}
          </div>
        )}
      </button>
  ...
  return (
    <>
      ...
      >
        {/* Header/Logo */}
        <div className="p-6 border-b border-text-primary/5 mb-4">
          ...
          {!isCollapsed && (
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-2xl transition-all border border-text-primary/5 hover:border-brand-orange/30 group"
            >
          ...
          {isCollapsed && (
            <button
              onClick={handleBackToAccount}
              className="w-12 h-12 flex items-center justify-center bg-white/5 hover:bg-brand-orange text-gray-400 hover:text-white rounded-xl transition-all border border-text-primary/5 mx-auto group"
        ...
        <div className={cn(
          ...
          <div className={cn(
            "p-4 bg-white/5 rounded-[1.5rem] border border-text-primary/5 flex items-center gap-4 group cursor-default transition-all hover:bg-white/10",
        ...
        {/* Footer actions */}
        <div className="p-4 border-t border-text-primary/5 mt-auto">
          <button 
        ...
        {showExitConfirm && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-sm glass border border-text-primary/10 rounded-[2.5rem] p-8 shadow-2xl overflow-hidden"
            >
